        ...
        messages=[
            {
                "role": "system",
                "content": (
                    "Classify the user's complaint into one of the following categories: "
...
def extract_key_phrases(text: str) -> list[str]:
    ...
    try:
        ...
        return doc.key_phrases or []

    except Exception:
        # If Azure client isn't configured or errors, return empty list
        return []
